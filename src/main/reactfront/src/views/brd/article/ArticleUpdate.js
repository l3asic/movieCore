...
const ArticleUpdate = () => {
  ...
  let [pageSubject, setPageSubject] = useState('');
  ...
  // useEffect(() => { debugger;
  //   if(articleData.length > 0 || articleData != null ){
  //     setPageSubject('게시글 수정 창');
  //   } else {
  //     setPageSubject('게시글 작성 창');
  //   }
  // }, [])
  ...
  return (
    <>
      <h1 className="pb-lg-5"> 게시글 수정 창</h1>
      ...
      <CForm className="row g-3">
        ...
        <CCol md={9}>
          <div className="mb-1">
            ...
            <CFormInput type="" id="exampleFormControlInput1" placeholder="" name="subject" onChange={changeAtclBean} value={articleData[0].subject}/>
          </div>
        ...
        <CCol md={12}>
          <div className="mb-3">
            ...
            <CFormTextarea id="exampleFormControlTextarea1" rows={10} name="content" onChange={changeAtclBean} value={articleData[0].content}></CFormTextarea>
          </div>
        </CCol>
